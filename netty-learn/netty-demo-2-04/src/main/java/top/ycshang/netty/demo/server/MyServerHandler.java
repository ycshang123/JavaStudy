...
import top.ycshang.netty.demo.domain.*;
import top.ycshang.netty.demo.util.CacheUtil;
import top.ycshang.netty.demo.util.FileUtil;
...
public class MyServerHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
      final FileTransferProtocol fileTransferProtocol = null;
        //数据格式验证
        ...
        switch (fileTransferProtocol.getTransferType()) {
            ...
            case 2 :{
                ...
                FileBurstInstruct fileBurstInstruct = FileUtil.writeFile("/Users/mqxu/Desktop", fileBurstData);
