    ...
    public void start(Stage stage) throws IOException {
        ...
        ILoginMethod login = new LoginController(((userId, userPassword) -> {
            if ("admin".equals(userId) && "123123".equals(userPassword)) {
                ...
                chat.addTalkMsgRight("10002", "计算机科学领域的所有问题都可以通过其他方式间接解决。", new Date(), true, true, false);
                ...
                chat.addTalkMsgRight("10003", " Java之于JavaScript如同Car之于Carpet。", new Date(), true, false, false);
                chat.addTalkMsgUserLeft("10003", "计算机善于遵循指令，但不善于理解你的思维。", new Date(), true, true, false);
                ...
                chat.addTalkMsgGroupLeft("5001502", "10001", "陶然然", "https://cdn.jsdelivr.net/gh/mqxu/wiki-image@master/avatar/me.5y3oh3q7cy00.jpg", "没有优秀的团队，无法打造出优秀的软件。大部分的软件团队看上去就像内部不和谐的家庭。。", new Date(), true, false, true);
                chat.addTalkMsgRight("5001502",   "拙劣的程序员担心代码。好的程序员担心数据结构及它们的关系。", new Date(), false, false, true);
                chat.addTalkMsgGroupLeft("5001502", "10003", "陈蓉琪", "https://wx3.sinaimg.cn/mw690/00669kengy1gux8qzbuerj60fu0b2wfe02.jpg", "优良设计创造价值的速度，快于其增加成本的速度。", new Date(), false, false, true);
                chat.addTalkMsgGroupLeft("5001502", "10002", "杨阳", "https://wx4.sinaimg.cn/mw690/00669kengy1gumd7zbqknj60i20i1tde02.jpg", "为了理解递归，我们首先要理解的是递归。", new Date(), true, false, true);
                chat.addTalkMsgGroupLeft("5001502", "10004", "王林", "https://wx2.sinaimg.cn/mw690/00669kengy1gumd86b16ij60fh0fh76f02.jpg", " 理论上，理论和实践是没有差异的。但实践中，是有的。", new Date(), true, false, true);
