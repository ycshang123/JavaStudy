...
import top.ycshang.chat.domain.user.repository.IUserRepository;
import top.ycshang.chat.infrastructure.dao.*;
import top.ycshang.chat.infrastructure.po.*;

import java.util.ArrayList;
import java.util.List;

import static top.ycshang.chat.infrastructure.common.Constants.TalkType.Friend;
import static top.ycshang.chat.infrastructure.common.Constants.TalkType.Group;
